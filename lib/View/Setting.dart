  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        _menuItem(AppLocalizations.of(context).termsOfUse, Icon(Icons.verified_user_outlined), _termsNavigate),
        _menuItem(AppLocalizations.of(context).privacyPolicy, Icon(Icons.privacy_tip_outlined), _privacyPolicyNavigate),
        _menuItem(AppLocalizations.of(context).version, Icon(Icons.system_update_alt_rounded)),
        // TODO: i18n対応
